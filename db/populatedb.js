...
async function authorCreate(index, firstName, familyName, birth, death) {
	const authordetail = { first_name: firstName, family_name: familyName };
	authordetail.date_of_birth = birth ? birth : authordetail.date_of_birth;
	authordetail.date_of_death = death ? death : authordetail.date_of_death;
...
async function bookCreate(index, title, summary, isbn, author, genre) {
	...
	bookdetail.genre = genre ? genre : bookdetail.genre;
...
async function bookInstanceCreate(index, book, imprint, dueBack, status) {
	...
	bookInstanceDetail.due_back = dueBack ? dueBack : bookInstanceDetail.due_back;
	bookInstanceDetail.status = status ? status : bookInstanceDetail.status;
